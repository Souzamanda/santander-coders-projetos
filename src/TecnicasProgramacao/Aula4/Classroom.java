package TecnicasProgramacao.Aula4;
...
public class Classroom {
    public static void main(String[] args) {
        ...
        System.out.println("Minimo: " + finityStream2.min((x,y) -> x - y).get());

        Stream<Integer> finityStream3 = Stream.iterate(10, predicate, unaryOperator);
        System.out.println("Maximo: " + finityStream3.max((x,y) -> x - y).get());
        ...
        System.out.println("Find first:" + finityStream4.findFirst().get());

        Stream<Integer> finityStream5 = Stream.iterate(10, predicate, unaryOperator);
        finityStream5.findAny().ifPresent(System.out::println);
        ...
        Predicate<String> predicate1 = x -> x.charAt(0) == 'J';

        System.out.println("allMatch() em Stream infinita: " + list.stream().allMatch(predicate1)); //retorna no primeiro false
        System.out.println("anyMatch() em Stream infinita: " + list.stream().anyMatch(predicate1)); //retorna no primeiro true
        System.out.println("noneMatch() em Stream infinita: " + list.stream().noneMatch(predicate1)); //retorna no primeiro false
        System.out.println();
        ...
        System.out.println("allMatch() em Stream infinita: " + infinityStreamInt1.allMatch(predicate2));
        System.out.println("anyMatch() em Stream infinita: " + infinityStreamInt2.anyMatch(predicate2));
        System.out.println("noneMatch() em Stream infinita: " + infinityStreamInt3.noneMatch(predicate2));
        System.out.println();
        ...
        streamSkipLimit.skip(2).limit(4).forEach(System.out::println);
        System.out.println();
