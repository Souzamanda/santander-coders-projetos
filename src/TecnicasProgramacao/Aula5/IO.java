...
public class IO {
    public static void main(String[] args) throws IOException {
        ...
        // File(URI uri)
        // ...
        File arquivoIO = new File("src/resources/test.txt");

        // Java NIO (Path) -> interface representando o caminho de um arquivo
        // Path.of(String, String...)
        // Path.of(String, String...)
        // Path.of("src ", "resources/", "test.txt");
        // ALTERNATIVA: Paths.get()
        Path arquivoNIO = Path.of("src/resources/test.txt");
        ...
        Path desafio1 = Path.of("src/resources/test.txt");
